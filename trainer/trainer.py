...
class ContrastiveTrainer:
    ...
    def __init__(self, model, train_loader, val_loader, criterion, optimizer, 
                 ...
                 output_dir='output', save_best=True, log_interval=10):
        """
        Args:
    ...
    def _train_epoch(self, epoch):
        ...
        with tqdm(self.train_loader, desc=f"Epoch {epoch+1}/{self.num_epochs} - Train") as pbar:
            for batch_idx, batch in enumerate(pbar):
                ...
                # Compute loss
                loss = self.criterion(
                    outputs['pre_projected'], 
                    outputs['post_projected'], 
                    is_positive
                )
                ...
                if 'change_score' in outputs:
                    predictions = (outputs['change_score'] < 0.5).float()  # Low score = positive pair
