...
class SupervisedContrastiveLoss(nn.Module):
    ...
    def forward(self, optical_features, sar_features, damage_labels):
        """
        Args:
            ...
            damage_labels: Binary labels (0: no/minor damage, 1: major damage) (batch_size,)
        """
        # Normalize features
        ...
        target_similarity = 1.0 - damage_labels.float()  # 1 for undamaged, 0 for damaged
